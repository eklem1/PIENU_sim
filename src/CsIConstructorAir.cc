...
CsIConstructorAir::~CsIConstructorAir() {}

void CsIConstructorAir::Init(void) {
...
G4LogicalVolume* CsIConstructorAir::GetPiece(void) {
...
G4LogicalVolume* CsIConstructorAir::ConstructCsI_Frame(void)
{
  inch = 2.54*cm;
...
void CsIConstructorAir::ConstructCsI_Upstream(void)
{
  inch = 2.54*cm;
  ...
  *g4rot = g4rot->inverse();
  ...
  G4LogicalVolume* crystal14_log
    = new G4LogicalVolume(crystal14_displaced,FindMaterial("G4_AIR"),
                                                            "Crystal14",0,0,0);
  G4LogicalVolume* crystal21i_log
    = new G4LogicalVolume(crystal21i_displaced,FindMaterial("G4_AIR"),
                                                            "Crystal21",0,0,0);
  G4LogicalVolume* crystal21o_log
    = new G4LogicalVolume(crystal21o_displaced,FindMaterial("G4_AIR"),
                                                            "Crystal21",0,0,0);
  G4LogicalVolume* crystal27_log
    = new G4LogicalVolume(crystal27_displaced,FindMaterial("G4_AIR"),
                                                           "Crystal27U",0,0,0);
...
void CsIConstructorAir::ConstructCsI_Downstream(void)
{
  inch = 2.54*cm;
  ...
  *g4rot = g4rot->inverse();
  ...
  G4LogicalVolume* crystal19i_log
    = new G4LogicalVolume(crystal19i_displaced,FindMaterial("G4_AIR"),
                                                            "Crystal19",0,0,0);
  G4LogicalVolume* crystal19o_log
    = new G4LogicalVolume(crystal19o_displaced,FindMaterial("G4_AIR"),
                                                            "Crystal19",0,0,0);
  G4LogicalVolume* crystal25_log
    = new G4LogicalVolume(crystal25_displaced,FindMaterial("G4_AIR"),
                                                           "Crystal25",0,0,0);
  G4LogicalVolume* crystal27_log
    = new G4LogicalVolume(crystal27_displaced,FindMaterial("G4_AIR"),
                                                           "Crystal27D",0,0,0);
