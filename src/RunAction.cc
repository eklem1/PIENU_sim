...
void RunAction::OpenRoot() {
  ...
  // Intelligently select filenames to use for output
    ...
    hitTuple = new TNtuple("hits","Hits","eventID:volumeID0:volumeID1:volumeID2:energyDeposit:startX:startY:startZ:startT:stopX:stopY:stopZ:stopT:Ebirk:PID:CreatorProcess:LimitingProcessID:TrackID:ParentID:MomX:MomY:MomZ:BINAflag",40000);
