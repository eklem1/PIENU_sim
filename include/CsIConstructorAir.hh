#ifndef CsIConstructorAir_h
#define CsIConstructorAir_h 1
...
class CsIConstructorAir : public GeoConstructor {

  public:

    CsIConstructorAir(G4String n, DetectorConstruction* c)
       : GeoConstructor(n,c) {Init();};

    CsIConstructorAir(G4String n, GeoConstructor* p)
       : GeoConstructor(n,p) {Init();};

    virtual ~CsIConstructorAir();
