...
// ------------------------------------------------------------
//
#ifndef G4DecayWithSpinDepol_h
#define G4DecayWithSpinDepol_h 1
...
class G4DecayWithSpinDepol : public G4Decay
{
  public:
    //  Constructors
    G4DecayWithSpinDepol(const G4String& processName ="DecayWithSpin");

    //  Destructor
    virtual ~G4DecayWithSpinDepol();
